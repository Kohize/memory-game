...
export default function Menu() {
  ...
  return (
    <div
      className="flex justify-center items-center h-screen bg-cover bg-center bg-no-repeat p-5"
      style={
        theme === 'light'
      ...
      <section className="flex flex-col items-center justify-center">
        <div className="flex md:p-5 flex-col gap-y-15 py-5 bg-white rounded-xl border-1 border-cyan-800">
          <StartingScreen />
        </div>
      </section>
    </div>
